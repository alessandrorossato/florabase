...
export interface paths {
    ...
    "/api/v1/botanical-identities/{botanical_identity_id}/cover-image/thumbnail": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Botanical Identity Cover Thumbnail */
        get: operations["getBotanicalIdentityCoverThumbnail"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** Body_createAttachment */
        Body_createAttachment: {
            /**
             * File
             * @description JPEG, PNG, or WebP attachment
             */
            file: string;
        };
...
export interface operations {
    createAttachment: {
        ...
        requestBody: {
            content: {
                "multipart/form-data": components["schemas"]["Body_createAttachment"];
            };
        };
        responses: {
    ...
    getBotanicalIdentityCoverThumbnail: {
        parameters: {
            query?: never;
            header?: {
